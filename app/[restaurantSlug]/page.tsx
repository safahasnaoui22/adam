...
export default async function RestaurantLandingPage({ params }: PageProps) {
  ...
  console.log("Looking for restaurant with slug:", restaurantSlug); // Debug log
  ...
  try {
    ...
    console.log("Found restaurant:", restaurant ? restaurant.name : "Not found"); // Debug log
    ...
    console.error("Error in restaurant page:", error);
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-red-600">Erreur</h1>
          <p className="mt-2">Une erreur est survenue lors du chargement de la page.</p>
        </div>
      </div>
    );
  }
