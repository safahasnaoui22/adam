 ...
 {activeTab === "business" && (
  <div className="bg-gradient-to-br from-[#0d1f3c] to-[#0a1628] rounded-xl shadow-xl border border-[#1e3a5f]/40 p-6 md:p-8 space-y-8 transition-all duration-300">
      ...
      <div className="space-y-5">
        ...
        <div className="group">
          ...
          <input
            ...
            className="w-full px-4 py-2.5 bg-[#0a1628] border border-[#1e3a5f] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#fe5502]/50 focus:border-[#fe5502] text-white placeholder-gray-500 transition-all duration-200"
    ...
    <div className="border-t border-[#1e3a5f]/60 pt-6 mt-2">
      ...
      {/* Repeat similar style for Facebook, Instagram, Twitter – same layout but with different icons and colors */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {[
          { platform: "Facebook", url: formData.facebookUrl, setUrl: (v: string) => setFormData({ ...formData, facebookUrl: v }), stars: formData.facebookBonusStars, setStars: (v: number) => setFormData({ ...formData, facebookBonusStars: v }), icon: "📘", color: "blue" },
          { platform: "Instagram", url: formData.instagramUrl, setUrl: (v: string) => setFormData({ ...formData, instagramUrl: v }), stars: formData.instagramBonusStars, setStars: (v: number) => setFormData({ ...formData, instagramBonusStars: v }), icon: "📸", color: "pink" },
          { platform: "Twitter/X", url: formData.twitterUrl, setUrl: (v: string) => setFormData({ ...formData, twitterUrl: v }), stars: formData.twitterBonusStars, setStars: (v: number) => setFormData({ ...formData, twitterBonusStars: v }), icon: "🐦", color: "gray" },
        ].map((social) => (
